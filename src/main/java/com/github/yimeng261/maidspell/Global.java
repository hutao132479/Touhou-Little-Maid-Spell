...
public class Global {
    ...
    public static HashMap<String,BiFunction<LivingHurtEvent,EntityMaid,Void>> bauble_damageProcessors = new HashMap<>();

    public static HashMap<String,BiFunction<LivingHurtEvent,EntityMaid,Void>> bauble_hurtProcessors = new HashMap<>();
}
